...
using Xamarin.Forms;
using TrackingYourLocation.Droid.Services;

[assembly: Dependency(typeof(AndroidNotificationManager))]
namespace TrackingYourLocation.Droid.Services
{
    public class AndroidNotificationManager : INotificationManager
    {
        ...
        public const string TitleKey = StringValues.NOTIFICATION_TITLE_KEY;
        public const string MessageKey = StringValues.NOTIFICATION_MESSAGE_KEY;
